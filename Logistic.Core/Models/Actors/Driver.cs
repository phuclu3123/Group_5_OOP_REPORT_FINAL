...
namespace Logistic.Core.Models.Actors
{
    public class Driver : Staff, ITrackable
    {
        ...
        public List<Business.Vehicle> AssignedVehicles { get; private set; }
            ...
            : base(id, fullName, phoneNumber, email, address, birthDay, gender, accountId, staffId, Role.Driver, department, baseSalary, joinDate)
        {
            ...
            AssignedVehicles = new List<Business.Vehicle>();
            DeliveryCount = 0;
            BonusPerDelivery = 50000m;
            FuelAllowance = 1500000m;
        }

        public void AddAssignedVehicle(Business.Vehicle vehicle)
        {
